...
/* ./.libs/lt-test_framing.c - temporary wrapper executable for .libs/test_framing.exe
   Generated by libtool (GNU libtool) 2.4.6 Debian-2.4.6-15

   The test_framing program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "test_framing.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/bash\n", f);
  fputs ("\n", f);
  fputs ("# test_framing - temporary wrapper script for .libs/test_framing.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.6 Debian-2.4.6-15\n", f);
  fputs ("#\n", f);
  fputs ("# The test_framing program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("    echo \"test_framing.exe:test_framing:$LINENO: libtool wrapper (GNU libtool) ", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"test_framing.exe:test_framing:$LINENO: newargv[$lt_dump_args_N]: $lt", f);
  fputs ("_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"test_framing.exe:test_framing:$LINENO: newargv[0]: $progdir/$pro", f);
  fputs ("gram\" 1>&2\n", f);
  ...
  fputs ("\n", f);
  fputs ("  program='test_framing.exe'\n", f);
