...
/*extern const unsigned char _binary_Data_rsdk_start[] asm("_binary_Data_rsdk_start");
extern const unsigned char _binary_Data_rsdk_end[] asm("_binary_Data_rsdk_end");
extern const size_t* _binary_Data_rsdk_size asm("_binary_Data_rsdk_size");*/
#endif
